...
const enviarFormulario = () => {
    let nome = document.getElementById('nome').name;
    let bairro = document.getElementById('bairro').name;
    let endereco = document.getElementById('enderco').name;
    ...
    let pagamento = document.getElementById('pagamento').name;
